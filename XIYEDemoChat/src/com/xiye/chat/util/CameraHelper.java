...
import com.xiye.xiyedemochat.MyChatApp;
...
public class CameraHelper implements PreviewCallback {
    ...
    boolean isScreenOriatationPortrait() {
        return MyChatApp.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
